package com.jablazr.enhanced_equipment.menus;

import com.jablazr.enhanced_equipment.initializers.MenuInit;
import com.jablazr.enhanced_equipment.recipes.EnhancementRecipe;
import com.jablazr.enhanced_equipment.recipes.EquipmentType;
import com.jablazr.enhanced_equipment.recipes.RecipeList;
...
public class EnhancerMenu extends ItemCombinerMenu {
  ...
  @javax.annotation.Nullable private String itemName;
  ...
  public EnhancerMenu(
      int pContainerId, Inventory pPlayerInventory, ContainerLevelAccess pContainerLevelAccess) {
  ...
  public void createResult() {
    ...
    Optional<EnhancementRecipe> chosenRecipe =
        allRecipes.stream()
            .filter((recipe) -> recipe.type == type.get() && recipe.resource == resource)
            .findFirst();
