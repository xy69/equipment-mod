package com.jablazr.enhanced_equipment.events;
...
@Mod.EventBusSubscriber(modid = EnhancedEquipmentMod.MODID, bus = Mod.EventBusSubscriber.Bus.FORGE)
  ...
  public static void onEquipmentChanged(LivingEquipmentChangeEvent event) {
    if (event.getSlot().isArmor()) {
      ...
      if (speedStrenght > 0) {
        event
            .getEntity()
            .addEffect(new MobEffectInstance(MobEffects.MOVEMENT_SPEED, -1, speedStrenght - 1));
      }
    } else {
